...
namespace backend {   
    ...
    public:
        ReduceLogSumExp(std::string, parameter_descriptor _parameter_descriptor);
...
namespace backend {    
    ...
    ReduceLogSumExp::ReduceLogSumExp(std::string n, parameter_descriptor _parameter_descriptor) : Layer(n) {
