...
namespace backend {
    class Min : public Layer {
        struct Params{Shape_t data_0_t; Shape_t min_t;
        };
        ...
        std::string data_0; std::string min;
        //parameter 
        Shape_t data_0_t; Shape_t min_t;
    ...
    public:
        Min(std::string n, std::vector<std::string> i, std::vector<std::string> o, std::map<std::string, std::vector<std::string>> a): Layer(n, i, o, a) {
            ...
            program->bind({data_0_t, min_t }, tensor_dict[min], tensor_dict[data_0]);
