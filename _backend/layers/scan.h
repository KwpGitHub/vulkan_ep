...
namespace layers {   
    ...
    class Scan : public backend::Layer {
        ...
        int m_body; int m_num_scan_inputs; std::vector<int> m_scan_input_axes; std::vector<int> m_scan_input_directions; std::vector<int> m_scan_output_axes; std::vector<int> m_scan_output_directions;
        ...
        std::string m_y0_o; std::string m_y1_o; std::string m_y2_o; std::string m_y3_o; std::string m_y4_o; std::string m_y5_o; std::string m_y6_o; std::string m_y7_o; std::string m_y8_o; std::string m_y9_o; std::string m_y10_o; std::string m_y11_o; std::string m_y12_o; std::string m_y13_o; std::string m_y14_o; std::string m_y15_o; std::string m_y16_o; std::string m_y17_o; std::string m_y18_o; std::string m_y19_o; std::string m_y20_o; std::string m_y21_o; std::string m_y22_o; std::string m_y23_o; std::string m_y24_o; std::string m_y25_o; std::string m_y26_o; std::string m_y27_o; std::string m_y28_o; std::string m_y29_o; std::string m_y30_o; std::string m_y31_o;
