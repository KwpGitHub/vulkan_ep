...
namespace backend {
    class RandomUniformLike : public Layer {
        struct Params{Shape_t input_t; Shape_t output_t; int dtype_t; float high_t; float low_t; float seed_t;
        };
        ...
        //parameter 
        Shape_t input_t; Shape_t output_t; int dtype_t; float high_t; float low_t; float seed_t;
    ...
    public:
        RandomUniformLike(std::string n, std::vector<std::string> i, std::vector<std::string> o, std::map<std::string, std::vector<std::string>> a): Layer(n, i, o, a) {
            ...
            program->bind({input_t, output_t, dtype_t, high_t, low_t, seed_t }, tensor_dict[output], tensor_dict[input]);
