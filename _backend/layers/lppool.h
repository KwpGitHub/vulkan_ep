...
namespace backend {
    class LpPool : public Layer {
        struct Params{Shape_t X_t; Shape_t Y_t; int auto_pad_t; Shape_t kernel_shape_t; int p_t; Shape_t pads_t; Shape_t strides_t;
        };
        ...
        //parameter 
        Shape_t X_t; Shape_t Y_t; int auto_pad_t; Shape_t kernel_shape_t; int p_t; Shape_t pads_t; Shape_t strides_t;
    ...
    public:
        LpPool(std::string n, std::vector<std::string> i, std::vector<std::string> o, std::map<std::string, std::vector<std::string>> a): Layer(n, i, o, a) {
            ...
            program->bind({X_t, Y_t, auto_pad_t, kernel_shape_t, p_t, pads_t, strides_t }, tensor_dict[Y], tensor_dict[X]);
