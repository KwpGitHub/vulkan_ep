...
namespace backend {
    class FeatureVectorizer : public Layer {
        struct Params{Shape_t X_t; Shape_t Y_t; Shape_t inputdimensions_t;
        };
        ...
        //parameter 
        Shape_t X_t; Shape_t Y_t; Shape_t inputdimensions_t;
    ...
    public:
        FeatureVectorizer(std::string n, std::vector<std::string> i, std::vector<std::string> o, std::map<std::string, std::vector<std::string>> a): Layer(n, i, o, a) {
            ...
            program->bind({X_t, Y_t, inputdimensions_t }, tensor_dict[Y], tensor_dict[X]);
        ...
        void parameter_proc(std::map<std::string, std::vector<std::string>> a){
			...
			convert_vec_param(a["inputdimensions"], inputdimensions_t);   
        }
