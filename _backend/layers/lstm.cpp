...
namespace backend {    
    ...
    LSTM::LSTM(std::string n) : Layer(n) { }
    ...
    void LSTM::bind(std::string _activation_alpha, std::string _activation_beta, std::string _activations, std::string _X_input, std::string _W_input, std::string _R_input, std::string _B_input_opt, std::string _sequence_lens_input_opt, std::string _initial_h_input_opt, std::string _initial_c_input_opt, std::string _P_input_opt, std::string _Y_output_opt, std::string _Y_h_output_opt, std::string _Y_c_output_opt){
        activation_alpha = _activation_alpha; activation_beta = _activation_beta; activations = _activations; X_input = _X_input; W_input = _W_input; R_input = _R_input; B_input_opt = _B_input_opt; sequence_lens_input_opt = _sequence_lens_input_opt; initial_h_input_opt = _initial_h_input_opt; initial_c_input_opt = _initial_c_input_opt; P_input_opt = _P_input_opt; Y_output_opt = _Y_output_opt; Y_h_output_opt = _Y_h_output_opt; Y_c_output_opt = _Y_c_output_opt;
