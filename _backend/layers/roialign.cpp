...
namespace layers {    
    ...
    void RoiAlign::build(){     
        ...
        program->bind({0}, *_SHAPES, *backend::tensor_dict[m_X_i]->data, *backend::tensor_dict[m_rois_i]->data, *backend::tensor_dict[m_batch_indices_i]->data, *backend::tensor_dict[m_Y_o]->data);
    }
