...
namespace backend {
    class Expand : public Layer {
        struct Params{Shape_t input_t; Shape_t shape_t; Shape_t output_t;
        };
        ...
        std::string input; std::string shape; std::string output;
        //parameter 
        Shape_t input_t; Shape_t shape_t; Shape_t output_t;
    ...
    public:
        Expand(std::string n, std::vector<std::string> i, std::vector<std::string> o, std::map<std::string, std::vector<std::string>> a): Layer(n, i, o, a) {
            ...
            program->bind({input_t, shape_t, output_t }, tensor_dict[output], tensor_dict[input], tensor_dict[shape]);
