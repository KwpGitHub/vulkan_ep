...
namespace backend {
    class Cast : public Layer {
        struct Params{Shape_t input_t; Shape_t output_t; int to_t;
        };
        ...
        //parameter 
        Shape_t input_t; Shape_t output_t; int to_t;
    ...
    public:
        Cast(std::string n, std::vector<std::string> i, std::vector<std::string> o, std::map<std::string, std::vector<std::string>> a): Layer(n, i, o, a) {
            ...
            program->bind({input_t, output_t, to_t }, tensor_dict[output], tensor_dict[input]);
