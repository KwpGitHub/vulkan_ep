...
namespace layers {   
    ...
    class QLinearConv : public backend::Layer {
        ...
        std::string m_x_i; std::string m_x_scale_i; std::string m_x_zero_point_i; std::string m_w_i; std::string m_w_scale_i; std::string m_w_zero_point_i; std::string m_y_scale_i; std::string m_y_zero_point_i;
        std::string m_B_i;
        std::string m_y_o;
