...
namespace backend {
    PYBIND11_MODULE(_backend, m) {
        py::class_<QLinearConv, Layer>(m, "QLinearConv")
            ...
            .def("init", &QLinearConv::init)
            .def("call", (void (QLinearConv::*) (std::string, std::string, std::string, std::string, std::string, std::string, std::string, std::string, std::string, std::string)) &QLinearConv::call);
    }
}
