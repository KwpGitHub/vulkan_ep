...
namespace layers {    
    ...
    void Concat::build(){     
        ...
        program->bind({0}, *_SHAPES, *backend::tensor_dict[m_x0_i]->data, *backend::tensor_dict[m_x1_i]->data, *backend::tensor_dict[m_x2_i]->data, *backend::tensor_dict[m_x3_i]->data, *backend::tensor_dict[m_x4_i]->data, *backend::tensor_dict[m_x5_i]->data, *backend::tensor_dict[m_x6_i]->data, *backend::tensor_dict[m_x7_i]->data, *backend::tensor_dict[m_x8_i]->data, *backend::tensor_dict[m_x9_i]->data, *backend::tensor_dict[m_x10_i]->data, *backend::tensor_dict[m_x11_i]->data, *backend::tensor_dict[m_x12_i]->data, *backend::tensor_dict[m_x13_i]->data, *backend::tensor_dict[m_x14_i]->data, *backend::tensor_dict[m_x15_i]->data, *backend::tensor_dict[m_x16_i]->data, *backend::tensor_dict[m_x17_i]->data, *backend::tensor_dict[m_x18_i]->data, *backend::tensor_dict[m_x19_i]->data, *backend::tensor_dict[m_x20_i]->data, *backend::tensor_dict[m_x21_i]->data, *backend::tensor_dict[m_x22_i]->data, *backend::tensor_dict[m_x23_i]->data, *backend::tensor_dict[m_x24_i]->data, *backend::tensor_dict[m_x25_i]->data, *backend::tensor_dict[m_x26_i]->data, *backend::tensor_dict[m_x27_i]->data, *backend::tensor_dict[m_x28_i]->data, *backend::tensor_dict[m_x29_i]->data, *backend::tensor_dict[m_x30_i]->data, *backend::tensor_dict[m_x31_i]->data, *backend::tensor_dict[m_concat_result_o]->data);
    }
