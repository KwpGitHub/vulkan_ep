...
namespace layers {    
    ...
    void Concat::bind(std::string _x0_i, std::string _x1_i, std::string _x2_i, std::string _x3_i, std::string _x4_i, std::string _x5_i, std::string _x6_i, std::string _x7_i, std::string _x8_i, std::string _x9_i, std::string _x10_i, std::string _x11_i, std::string _x12_i, std::string _x13_i, std::string _x14_i, std::string _x15_i, std::string _x16_i, std::string _x17_i, std::string _x18_i, std::string _x19_i, std::string _x20_i, std::string _x21_i, std::string _x22_i, std::string _x23_i, std::string _x24_i, std::string _x25_i, std::string _x26_i, std::string _x27_i, std::string _x28_i, std::string _x29_i, std::string _x30_i, std::string _x31_i, std::string _concat_result_o){    
		...
		SHAPES.push_back(backend::tensor_dict[m_concat_result_o]->shape());
    ...
    void Concat::build(){     
        ...
        program->bind({128}, *_SHAPES, *backend::tensor_dict[m_x0_i]->data, *backend::tensor_dict[m_x1_i]->data, *backend::tensor_dict[m_x2_i]->data, *backend::tensor_dict[m_x3_i]->data, *backend::tensor_dict[m_x4_i]->data, *backend::tensor_dict[m_x5_i]->data, *backend::tensor_dict[m_x6_i]->data, *backend::tensor_dict[m_x7_i]->data, *backend::tensor_dict[m_x8_i]->data, *backend::tensor_dict[m_x9_i]->data, *backend::tensor_dict[m_x10_i]->data, *backend::tensor_dict[m_x11_i]->data, *backend::tensor_dict[m_x12_i]->data, *backend::tensor_dict[m_x13_i]->data, *backend::tensor_dict[m_x14_i]->data, *backend::tensor_dict[m_x15_i]->data, *backend::tensor_dict[m_x16_i]->data, *backend::tensor_dict[m_x17_i]->data, *backend::tensor_dict[m_x18_i]->data, *backend::tensor_dict[m_x19_i]->data, *backend::tensor_dict[m_x20_i]->data, *backend::tensor_dict[m_x21_i]->data, *backend::tensor_dict[m_x22_i]->data, *backend::tensor_dict[m_x23_i]->data, *backend::tensor_dict[m_x24_i]->data, *backend::tensor_dict[m_x25_i]->data, *backend::tensor_dict[m_x26_i]->data, *backend::tensor_dict[m_x27_i]->data, *backend::tensor_dict[m_x28_i]->data, *backend::tensor_dict[m_x29_i]->data, *backend::tensor_dict[m_x30_i]->data, *backend::tensor_dict[m_x31_i]->data, *backend::tensor_dict[m_concat_result_o]->data);
    }
