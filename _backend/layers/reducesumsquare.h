...
namespace backend {   
    ...
    public:
        ReduceSumSquare(std::string, parameter_descriptor _parameter_descriptor);
...
namespace backend {    
    ...
    ReduceSumSquare::ReduceSumSquare(std::string n, parameter_descriptor _parameter_descriptor) : Layer(n) {
