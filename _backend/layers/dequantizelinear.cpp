...
namespace layers {    
    ...
    void DequantizeLinear::build(){     
        ...
        program->bind({128}, *_SHAPES, *backend::tensor_dict[x_i]->data, *backend::tensor_dict[x_scale_i]->data, *backend::tensor_dict[x_zero_point_i]->data, *backend::tensor_dict[y_o]->data);
    }
