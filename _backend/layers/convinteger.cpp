...
namespace layers {    
    ...
    void ConvInteger::build(){     
        ...
        program->bind({128, 0.1f}, *_SHAPES, *backend::tensor_dict[x_i]->data, *backend::tensor_dict[w_i]->data, *backend::tensor_dict[x_zero_point_i]->data, *backend::tensor_dict[w_zero_point_i]->data, *backend::tensor_dict[y_o]->data);
    }
