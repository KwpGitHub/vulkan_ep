...
namespace backend {
    class ConvTranspose : public Layer {
        struct Params{Shape_t X_t; Shape_t W_t; Shape_t B_t; Shape_t Y_t; int auto_pad_t; Shape_t dilations_t; int group_t; Shape_t kernel_shape_t; Shape_t output_padding_t; Shape_t output_shape_t; Shape_t pads_t; Shape_t strides_t;
        };
        ...
        //parameter 
        Shape_t X_t; Shape_t W_t; Shape_t B_t; Shape_t Y_t; int auto_pad_t; Shape_t dilations_t; int group_t; Shape_t kernel_shape_t; Shape_t output_padding_t; Shape_t output_shape_t; Shape_t pads_t; Shape_t strides_t;
    ...
    public:
        ConvTranspose(std::string n, std::vector<std::string> i, std::vector<std::string> o, std::map<std::string, std::vector<std::string>> a): Layer(n, i, o, a) {
            ...
            program->bind({X_t, W_t, B_t, Y_t, auto_pad_t, dilations_t, group_t, kernel_shape_t, output_padding_t, output_shape_t, pads_t, strides_t }, tensor_dict[Y], tensor_dict[X], tensor_dict[W], tensor_dict[B]);
        ...
        void parameter_proc(std::map<std::string, std::vector<std::string>> a){
			...
			convert_vec_param(a["output_padding"], output_padding_t);
			convert_vec_param(a["output_shape"], output_shape_t);
