...
namespace backend {
    class Shrink : public Layer {
        struct Params{Shape_t input_t; Shape_t output_t; float bias_t; float lambd_t;
        };
        ...
        //parameter 
        Shape_t input_t; Shape_t output_t; float bias_t; float lambd_t;
    ...
    public:
        Shrink(std::string n, std::vector<std::string> i, std::vector<std::string> o, std::map<std::string, std::vector<std::string>> a): Layer(n, i, o, a) {
            ...
            program->bind({input_t, output_t, bias_t, lambd_t }, tensor_dict[output], tensor_dict[input]);
        ...
        void parameter_proc(std::map<std::string, std::vector<std::string>> a){
			...
			convert_vec_param(a["lambd"], lambd_t);   
        }
