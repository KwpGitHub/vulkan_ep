...
namespace backend {
    class Selu : public Layer {
        struct Params{Shape_t X_t; Shape_t Y_t; float alpha_t; float gamma_t;
        };
        ...
        //parameter 
        Shape_t X_t; Shape_t Y_t; float alpha_t; float gamma_t;
    ...
    public:
        Selu(std::string n, std::vector<std::string> i, std::vector<std::string> o, std::map<std::string, std::vector<std::string>> a): Layer(n, i, o, a) {
            ...
            program->bind({X_t, Y_t, alpha_t, gamma_t }, tensor_dict[Y], tensor_dict[X]);
        ...
        void parameter_proc(std::map<std::string, std::vector<std::string>> a){
			...
			convert_vec_param(a["gamma"], gamma_t);   
        }
