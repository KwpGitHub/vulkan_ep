...
namespace layers {    
    ...
    void Scatter::build(){     
        ...
        program->bind({128}, *_SHAPES, *backend::tensor_dict[m_data_i]->data, *backend::tensor_dict[m_indices_i]->data, *backend::tensor_dict[m_updates_i]->data, *backend::tensor_dict[m_output_o]->data);
    }
