...
namespace layers {    
    ...
    void Scatter::build(){     
        ...
        program->bind({128, 0.1f}, *_SHAPES, *backend::tensor_dict[data_i]->data, *backend::tensor_dict[indices_i]->data, *backend::tensor_dict[updates_i]->data, *backend::tensor_dict[output_o]->data);
    }
