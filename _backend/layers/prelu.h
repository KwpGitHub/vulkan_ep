...
namespace backend {
    class PRelu : public Layer {
        struct Params{Shape_t X_t; Shape_t slope_t; Shape_t Y_t;
        };
        ...
        std::string X; std::string slope; std::string Y;
        //parameter 
        Shape_t X_t; Shape_t slope_t; Shape_t Y_t;
    ...
    public:
        PRelu(std::string n, std::vector<std::string> i, std::vector<std::string> o, std::map<std::string, std::vector<std::string>> a): Layer(n, i, o, a) {
            ...
            program->bind({X_t, slope_t, Y_t }, tensor_dict[Y], tensor_dict[X], tensor_dict[slope]);

        }
        
        void parameter_proc(std::map<std::string, std::vector<std::string>> a){
            convert_vec_param(a["X"], X_t);
			convert_vec_param(a["slope"], slope_t);
