...
namespace layers {    
    ...
    void OneHot::build(){     
        ...
        program->bind({128}, *_SHAPES, *backend::tensor_dict[m_indices_i]->data, *backend::tensor_dict[m_depth_i]->data, *backend::tensor_dict[m_values_i]->data, *backend::tensor_dict[m_output_o]->data);
    }
