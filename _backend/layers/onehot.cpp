...
namespace layers {    
    ...
    void OneHot::build(){     
        ...
        program->bind({128, 0.1f}, *_SHAPES, *backend::tensor_dict[indices_i]->data, *backend::tensor_dict[depth_i]->data, *backend::tensor_dict[values_i]->data, *backend::tensor_dict[output_o]->data);
    }
